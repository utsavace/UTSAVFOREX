...
const ASSETS: Asset[] = [
  ...
  // Best: GBPUSD(PF2.76), USDCHF(PF2.72), EURUSD(PF1.61), EURGBP(PF3.92)
  { sym: "EURUSD=X", name: "EUR/USD",   cat: "Forex" },
  { sym: "GBPUSD=X", name: "GBP/USD",   cat: "Forex" },
  { sym: "USDJPY=X", name: "USD/JPY ⚠️", cat: "Forex" }, // weak — PF 0.72
  { sym: "USDCHF=X", name: "USD/CHF",   cat: "Forex" },
  { sym: "AUDUSD=X", name: "AUD/USD ⚠️", cat: "Forex" }, // weak — PF 0.34
  ...
  // ── Crypto (8) — 5-EMA + Trend Analysis + Channel 55/20 ──
  // Best Trend Analysis: XRP(6.52), DOGE(6.10), LINK(4.54), BTC(4.04), ADA(2.90)
  // Best Channel 55/20: ETH(3.54), ADA(2.70), DOT(2.27), SOL(2.07)
  ...
  // ── Commodities (7) — 5-EMA ──
  // Best: Silver(PF1.49), Copper(PF1.44) — rest marginal
  ...
  // ── Stocks (19) — Channel 55/20 + 5-EMA ──
  // Removed: TSLA(PF0.24 weak), INTC(PF0.00 no wins in 5yr)
  // Best Channel 55/20: NFLX(3.53), NVDA(2.40), MSFT(1.50), AMZN(1.48), COST(1.48)
        ...
        <>
          ...
          <section className="panel main-panel">
            ...
            <div className="strat-legend">
              {[
                { name: "5-EMA Filtered",    oosPF: "1.92", win: "33%", assets: "Comm + Crypto + Stock", rr: "1:5" },
                ...
                { name: "Crypto EMA 20/50",  oosPF: "1.08", win: "42%", assets: "Crypto (marginal)",     rr: "1:3" },
              ].map(s => (
